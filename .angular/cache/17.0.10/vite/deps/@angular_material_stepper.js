...
function MatStepper_Case_0_For_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, MatStepper_Case_0_For_3_Conditional_1_Template, 1, 0, "div", 5);
  }
  if (rf & 2) {
    ...
    ɵɵproperty("ngTemplateOutlet", _r3)("ngTemplateOutletContext", ɵɵpureFunction2(3, _c1, step_r6, i_r7));
    ɵɵadvance();
    ɵɵconditional(1, !(i_r7 === $count_r9 - 1) ? 1 : -1);
  }
}
var _c2 = (a0) => ({
...
function MatStepper_Case_0_For_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("@horizontalStepTransition.done", function MatStepper_Case_0_For_6_Template_div_animation_horizontalStepTransition_done_0_listener($event) {
      ...
      return ɵɵresetView(ctx_r17._animationDone.next($event));
    });
  ...
  if (rf & 2) {
    ...
    ɵɵclassProp("mat-horizontal-stepper-content-inactive", ctx_r5.selectedIndex !== i_r13);
    ɵɵproperty("@horizontalStepTransition", ɵɵpureFunction2(8, _c3, ctx_r5._getAnimationDirection(i_r13), ɵɵpureFunction1(6, _c2, ctx_r5._getAnimationDuration())))("id", ctx_r5._getStepContentId(i_r13));
    ɵɵattribute("aria-labelledby", ctx_r5._getStepLabelId(i_r13));
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", step_r12.content);
  }
}
function MatStepper_Case_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵrepeaterCreate(5, MatStepper_Case_0_For_6_Template, 2, 11, "div", 9, ɵɵrepeaterTrackByIdentity);
    ɵɵelementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
...
function MatStepper_Case_1_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("@verticalStepTransition.done", function MatStepper_Case_1_For_1_Template_div_animation_verticalStepTransition_done_3_listener($event) {
      ...
      return ɵɵresetView(ctx_r25._animationDone.next($event));
    });
  ...
  if (rf & 2) {
    ...
    const _r3 = ɵɵreference(3);
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", _r3)("ngTemplateOutletContext", ɵɵpureFunction2(10, _c1, step_r20, i_r21));
    ɵɵadvance();
    ɵɵclassProp("mat-stepper-vertical-line", !(i_r21 === $count_r23 - 1));
    ɵɵadvance();
    ɵɵclassProp("mat-vertical-stepper-content-inactive", ctx_r19.selectedIndex !== i_r21);
    ɵɵproperty("@verticalStepTransition", ɵɵpureFunction2(15, _c3, ctx_r19._getAnimationDirection(i_r21), ɵɵpureFunction1(13, _c2, ctx_r19._getAnimationDuration())))("id", ctx_r19._getStepContentId(i_r21));
    ɵɵattribute("aria-labelledby", ctx_r19._getStepLabelId(i_r21));
    ɵɵadvance(2);
    ɵɵproperty("ngTemplateOutlet", step_r20.content);
  }
}
function MatStepper_Case_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵrepeaterCreate(0, MatStepper_Case_1_For_1_Template, 6, 18, "div", 14, ɵɵrepeaterTrackByIdentity);
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
...
function MatStepper_ng_template_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵclassProp("mat-horizontal-stepper-header", ctx_r2.orientation === "horizontal")("mat-vertical-stepper-header", ctx_r2.orientation === "vertical");
    ...
    ɵɵattribute("aria-posinset", i_r28 + 1)("aria-setsize", ctx_r2.steps.length)("aria-controls", ctx_r2._getStepContentId(i_r28))("aria-selected", ctx_r2.selectedIndex == i_r28)("aria-label", step_r27.ariaLabel || null)("aria-labelledby", !step_r27.ariaLabel && step_r27.ariaLabelledby ? step_r27.ariaLabelledby : null)("aria-disabled", ctx_r2._stepIsNavigable(i_r28, step_r27) ? null : true);
  }
}
...
var _MatStepHeader = class _MatStepHeader extends _MatStepHeaderBase {
...
_MatStepper.ɵcmp = ɵɵdefineComponent({
  ...
  template: function MatStepper_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵtemplate(0, MatStepper_Case_0_Template, 7, 0)(1, MatStepper_Case_1_Template, 2, 0)(2, MatStepper_ng_template_2_Template, 1, 23, "ng-template", null, 0, ɵɵtemplateRefExtractor);
    }
    if (rf & 2) {
      let MatStepper_contFlowTmp;
      ɵɵconditional(0, (MatStepper_contFlowTmp = ctx.orientation) === "horizontal" ? 0 : MatStepper_contFlowTmp === "vertical" ? 1 : -1);
    }
  },
